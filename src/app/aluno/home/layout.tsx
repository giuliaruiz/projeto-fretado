...
export default function Layout({ children }: RootLayoutProps) {
    ...
    return (
        <div className="w-screen h-screen flex flex-col md:grid md:grid-cols-[250px_1fr] z-50">
            ...
            <main className="m-auto w-5/6 h-[90%] flex-1 overflow-auto rounded-lg px-10 z-10 py-8 bg-[#333]">
                {children}
            </main>
        </div>
    );
